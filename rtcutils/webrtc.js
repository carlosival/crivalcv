  ...
  async connect() {
    ...
    try {
      ...
      const peerConfig = {
        ...
        handleIceCandidate: this.handleIceCandidateTricker,
      ...
      this.ws.onopen = async () => {
        ...
        try {
          ...
          console.log('[SDP] Offer initialized. Gathering candidates...');

          // If using Trickle ICE, send the offer immediately
          if (peerConfig.handleIceCandidate === this.handleIceCandidateTricker) {
            console.log('[Trickle ICE] Sending offer immediately...');
            this.sendOfferWebSocket();
          }
